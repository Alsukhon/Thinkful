...
"resource": {
  ...
  "tags":[{
      ...
      "metadata":["map"],
      "once_per_event":true,
      "vtp_html":["template","\u003Cscript type=\"text\/gtmscript\"\u003E(function(){for(var e=\"typeform.com\",f=\/(\u0026|\\?)utm_[A-Za-z]+=[A-Za-z0-9]+\/gi,c=document.getElementsByTagName(\"a\"),d=\"utm_medium\\x3d",["escape",["macro",19],7]," utm_source\\x3d",["escape",["macro",17],7]," utm_term\\x3d",["escape",["macro",20],7]," utm_content\\x3d",["escape",["macro",21],7]," payment_option\\x3d",["escape",["macro",22],7]," utm_campaign\\x3d",["escape",["macro",18],7],"\".split(\" \"),b=0;b\u003Cc.length;b+=1){var a=c[b].href;0\u003Ca.indexOf(e)\u0026\u0026(a=a.replace(f,\"\"),a=a.split(\"#\"),0\u003Ea[0].indexOf(\"?\")?a[0]+=\"?\"+d.join(\"\\x26\"):a[0]+=\"\\x26\"+d.join(\"\\x26\"),\na=a.join(\"#\"));c[b].href=a}})();\u003C\/script\u003E"],
      "vtp_supportDocumentWrite":false,
      "vtp_enableIframeMode":false,
      "vtp_enableEditJsMacroBehavior":false,
      "tag_id":105
  ...
  "rules":[
    ...
    [["if",27,42],["add",98]],
    [["if",33],["unless",43,44,45],["add",100,112]],
...
var Y={a:{}};Y.a.ctv=["google"],function(){(function(a){Y.__ctv=a;Y.__ctv.b="ctv";Y.__ctv.g=!0;Y.__ctv.priorityOverride=0})(function(){return"185"})}();
